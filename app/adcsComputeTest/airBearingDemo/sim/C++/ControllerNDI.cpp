    ...
    is_saturated(false)
{
    ...
    x_m(0) = Param::Orbit::InitialState.q0(1);
    x_m(1) = Param::Orbit::InitialState.q0(2);
    x_m(2) = Param::Orbit::InitialState.q0(3);
    x_m(3) = Param::Orbit::InitialState.q0(0);
    x_m.setSegment(4, Param::Orbit::InitialState.omega);
