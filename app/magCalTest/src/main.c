...
static const float MAG_BIAS[3][3] = {
	{-342.000f, 2022.000f, 1234.000f},
	{3238.500f, -2290.500f, 68.000f},
	{-320.500f, 2263.500f, -2411.000f},
};

static const float MAG_SCALE[3][3] = {
	{0.7760f, 1.2137f, 1.1270f},
	{0.8901f, 1.0149f, 1.1221f},
	{1.0108f, 0.8851f, 1.1353f},
};
