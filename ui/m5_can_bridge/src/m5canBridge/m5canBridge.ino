...
static constexpr bool ENABLE_EPS_LOAD_TEST = false;
static constexpr bool ENABLE_LOCAL_GPIO_LOOPBACK_TEST = false;   // Only true for raw GPIO test.
static constexpr uint8_t TX_TARGET_MOTOR = 0;                    // 1..4, or 0 for all motors.
static constexpr int16_t TX_RPM_REF_LOW = -2000;                  // Signed RPM command.
static constexpr int16_t TX_RPM_REF_HIGH = 3000;                 // Signed RPM command.
