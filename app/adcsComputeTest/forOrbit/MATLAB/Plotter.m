    ...
    methods
        ...
        function buildFigures(self, Param)
            ...
            if self.plot_measurements
                ...
                % Star Tracker (7:10) -> handles 70..73
                ...
                % Sun Sensors (11:16) -> handles 74..79
                subplot(2,3,4); hold on; grid on;
                sunc = {'r','g','b','k',[0.5 0.5 0.5],[0.9 0.4 0.1]}; % 6 channels
                for i = 1:6
        ...
        function update(self, t, state, estimate, reference, model, input, measurements, mode)
            ...
            measurements(1:6)   = rad2deg(measurements(1:6));     % (kept as in your original)
            ...
            % Translation ECI (r: handles 1..3, v: handles 4..6)
            if self.plot_translation
                for i = 1:3
