...
ObserverClass::ObserverClass()
    : // Initialize Members
    q_hat(Param::Orbit::InitialState.q0),
    beta_hat(Param::Sensors::beta_gyro),
    P(Param::Observer::P_0),
    G(Param::Observer::G),
    Q(Param::Observer::Q),
    sigma_v(Param::Sensors::sigma_gyro),
    sigma_u(Param::Sensors::sigma_bias_walk),
    ...
    T_quest(Param::Sensors::T_star),  // Use same update rate as star tracker
    I_max(Param::Sensors::I_max),
    last_q_star(Param::Orbit::InitialState.q0)  // Initialize to initial quaternion
{
...
ObserverClass::StateVector ObserverClass::update(const Param::Vector29& measurements, const Scalar& t) {
    ...
    Param::Vector3 V_hat = C_eci2ecef_out.transpose() * v_ecef_final + 
                           Param::Earth::omega_earth.cross(R_hat);
